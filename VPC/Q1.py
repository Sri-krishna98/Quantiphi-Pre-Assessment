...
vpc.create_tags(Tags=[{'Key':'Name', 'Value': 'dontdlt-sri'}])
...
ec2_client.create_tags(Resources=subnet_1_public_tag,Tags=[{'Key':'Name','Value':'public1'}])
ec2_client.create_tags(Resources=subnet_2_public_tag,Tags=[{'Key':'Name','Value':'public2'}])
ec2_client.create_tags(Resources=subnet_3_private_tag,Tags=[{'Key':'Name','Value':'private1'}])
ec2_client.create_tags(Resources=subnet_4_private_tag,Tags=[{'Key':'Name','Value':'private2'}])
